...
disabledButtonStyle = {"margin-left": "20px",
                       "font-size": "24px",
                       "color": "lightgray"}

liveButtonStyle = {"margin-left": "20px",
                       "font-size": "24px",
                       "color": "black"}
...
dashApp.layout=html.Div(
   ...
   children=[
     ...
     html.H4('Project Name',style={'display':'inline-block','margin-right':20}),
      ...
      html.Button("Submit", id="setProjectNameButton", n_clicks=0, disabled=True,
...
@callback(
     ...
     Output('setProjectNameButton', 'style'),
...
def handleInputChars(userEnteredString):
    ...
    if(characterCount >= minCharacterCount):
        buttonStyle = liveButtonStyle
        buttonDisabled = False
    else:
        buttonStyle = disabledButtonStyle
        buttonDisabled = True
    return(userEnteredString, buttonStyle, buttonDisabled)
#--------------------------------------------------------------------------------
@callback(
    Output('messageDiv', 'children', allow_duplicate=True),
