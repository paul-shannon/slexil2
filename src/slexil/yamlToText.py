...
******************************************************************
'''
# textFromYaml.py: a class to represent a complete IJAL interlinear text
...
class YamlToText:
   ...
   def __init__(self,
      ...
      self.yamlParser = NewYamlParser(yamlFile, self.verbose,
                                      self.fixOverlappingTimeSegments)
      self.yamlParser.run()
      #parsedYaml = yaml.load(open(yamlTextFile), Loader=yaml.FullLoader)
      #self.lines = parsedYaml['lines']
