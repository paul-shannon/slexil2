...
<ul>
   ...
   <li> Lexical affixes (or semantic affixes) are bound elements that appear as affixes, but
      function as 
      <a href="https://en.wikipedia.org/wiki/Incorporation_(linguistics)" target="_blank">incorporated nouns</a> 
      within verbs and as elements of nouns. They are similar
   ...
   <li> Lexical affixes are relatively rare. The Wakashan, Salishan, and Chimakuan languages all 
   ...
   <li> In this sense, they are unlike what is usually perceived as derivational affixes, which
      more often have little concrete meaning, rather serving to identify lexical classes.
   <li> Lexical suffixes have gone by several names. Sapir described them, rather than naming them, and
      called them ''verbal affixes that refer to nouns" (1911:251/1989 [1990]:28);
   <li> Reichard called them "nominal suffixes" (1938:601),
   <li> Vogt used the term "field-suffixes" (1940:58), and Kuipers divided them into "somatic suffixes"
      (1967:120) and "non-somatic suffixes" (1967:125).
   <li> The usage "1exical suffixes" was first used by Kinkade (1963:352), adopted from Vogt, who used this
   ...
   <li> Kinkade made the change because of the semantic similarity between these suffixes and usual lexical
      items (i.e. nouns). The term is now in  general use in discussing this class of affix in Salish,
      Chemakuan, and Wakashan studies.
   <li> A small number of prefixes found in some Salishan languages are often referred to as
